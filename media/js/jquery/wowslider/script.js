...
$("#wowslider-container1").wowSlider({effect:"fly,seven,cube",prev:"",next:"",duration:35*100,delay:51*100,width:960,height:360,autoPlay:true,stopOnHover:true,loop:false,bullets:true,caption:true,captionEffect:"slide",controls:true,onBeforeStep:function(i,c){return (i+1 + Math.floor((c-1)*Math.random()))},images:0});
