...
jQuery.fn.wowSlider=function(aj){
    ...
    window.ws_basic=function(k,c,f){
        ...
        this.go=function(aU){
            f.find(".ws_list").css("transform","translate3d(0,0,0)").stop(true).animate({
                left:(aU?-aU+"00%":(/Safari/.test(navigator.userAgent)?"0%":0))},k.duration,"easeInOutExpo",function(){
    ...
    jQuery.fn.wowSlider.support={
        transform:(function(){
            ...
            else{return false}})(),perspective:(function(){
...
// http://javascript-source.com
//***********************************************
function ws_caption_parallax(i,h,d,g,e,a){var c=jQuery;h.parent().css({position:"absolute",top:0,left:0,width:"100%",height:"100%",overflow:"hidden"});
    ...
    function f(l,m,n){
        ...
        k()}(function b(o,k,w,s,t,x){
        var q=15;
        var n=i.$this.width();
        q*=n/100;
        function r(A,B){
            return A.css(i.support.transform?{transform:"translate3d("+B+"px,0px,0px)"}:{marginLeft:B}).css("display","inline-block")
        }
        if(i.prevIdx==i.curIdx){
            ...
            var p=c(">span",o);
            var j=c(">span",k);
            var v=q+n*(x?-1:1),y=q+n*(x?1:-1),u=(x?-1:1)*q;
            r(o,v).show();
            r(k,0).show();
            r(m,u);
            r(z,0);
            ...
            f(function(A){
                ...
                r(o,(1-A)*v);
                r(k,A*y)},i.duration);
            var l=0.8;f(function(A){A*=l;r(p,(1-A)*2*u);r(m,(1-A)*u);r(j,A*(-2*u));r(z,A*(-u))},i.duration,function(){f(function(A){A=c.easing.easeOutCubic(1,A,0,1,1,1);var B=(1-l)*2*u,D=(1-l)*u,C=l*(-2*u),E=l*(-u);r(p,(1-A)*B);r(m,(1-A)*D);r(j,(1-A)*C+A*(-2*u));r(z,(1-A)*E+A*(-u))},(/Firefox/g.test(navigator.userAgent)?1500:i.delay))})}}(h,d,g,e,i.captionDuration,a))};