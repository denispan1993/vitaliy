                    ...
                    try:
                        ...
                        for real_email in emails:
                            try:
                                ...
                                print real_email.content_type.model_class()
                                print real_email.content_type.natural_key()
                                from django.contrib.contenttypes.models import ContentType

                                email = EmailForDelivery.objects.get(content_type=real_email.content_type,
...
#                                                             from_email=mail_account.email,
                                ...
                                sleep(25, ); print 'sleep1, '; sleep(25, ); print 'sleep2, '; sleep(25, ); print 'sleep3'
                                time += 60
                                print '8'
                            else:
                                print 'i: ', i, 'Pk: ', real_email.pk, ' - ', real_email.email
                                time1 = randrange(30, 45, )
                                time2 = randrange(30, 45, )
                                time += time1 + time2
