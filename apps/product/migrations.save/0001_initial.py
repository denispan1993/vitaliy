...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'Category', (
            ...
            ('url', self.gf('apps.product.models.ModelSlugField')(max_length=50, db_index=True)),
        ...
        db.create_table('Product', (
            ...
            ('is_availability', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('is_featured', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('url', self.gf('apps.product.models.ModelSlugField')(db_index=True, max_length=255, null=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ...
        db.create_table('Photo', (
            ...
            ('photo', self.gf('apps.product.models.ImageWithThumbsField')(max_length=100)),
