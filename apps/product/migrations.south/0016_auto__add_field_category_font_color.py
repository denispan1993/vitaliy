...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.font_color'
        db.add_column('Category', 'font_color',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.font_color'
        db.delete_column('Category', 'font_color')
    ...
    models = {
        ...
        u'discount.action': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "u'\\u0410\\u043a\\u0446\\u0438\\u044f \\u043e\\u0442 2014-10-26 12:01:51.234264'", 'max_length': '256'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
