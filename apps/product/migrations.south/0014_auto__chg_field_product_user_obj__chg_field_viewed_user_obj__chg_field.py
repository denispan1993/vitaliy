...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field action on 'Product'
        m2m_table_name = 'Product_to_Action'
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('product', models.ForeignKey(orm[u'product.product'], null=False)),
            ('action', models.ForeignKey(orm[u'discount.action'], null=False))
        ))
        db.create_unique(m2m_table_name, ['product_id', 'action_id'])


        # Changing field 'Product.user_obj'
        db.alter_column('Product', 'user_obj_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authModel.User'], null=True))

        # Changing field 'Viewed.user_obj'
        db.alter_column('Viewed', 'user_obj_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authModel.User'], null=True))

        # Changing field 'Category.user_obj'
        db.alter_column('Category', 'user_obj_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authModel.User'], null=True))

    def backwards(self, orm):
        # Removing M2M table for field action on 'Product'
        db.delete_table('Product_to_Action')


        # Changing field 'Product.user_obj'
        db.alter_column('Product', 'user_obj_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Viewed.user_obj'
        db.alter_column('Viewed', 'user_obj_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Category.user_obj'
        db.alter_column('Category', 'user_obj_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
