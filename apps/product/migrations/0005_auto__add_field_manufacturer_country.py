...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Manufacturer.country'
        db.add_column('Manufacturer', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['product.Country']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Manufacturer.country'
        db.delete_column('Manufacturer', 'country_id')
