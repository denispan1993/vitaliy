...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('Manufacturer', (
            ...
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='related_Manufacturer', to=orm['contenttypes.ContentType'])),
        ...
        # Adding field 'Category.letter_to_article'
        db.add_column('Category', 'letter_to_article',
                      self.gf('django.db.models.fields.CharField')(default='CAT', max_length=3),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Category.letter_to_article'
        db.delete_column('Category', 'letter_to_article')
    ...
    models = {
        ...
        u'product.category': {
            ...
            'letter_to_article': ('django.db.models.fields.CharField', [], {'default': "'CAT'", 'max_length': '3'}),
        ...
        u'product.manufacturer': {
            ...
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'related_Manufacturer'", 'to': u"orm['contenttypes.ContentType']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
