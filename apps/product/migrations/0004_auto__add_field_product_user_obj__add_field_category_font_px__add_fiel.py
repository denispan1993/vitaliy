...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.user_obj'
        db.add_column('Product', 'user_obj',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.font_px'
        db.add_column('Category', 'font_px',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=14),
                      keep_default=False)

        # Adding field 'Category.user_obj'
        db.add_column('Category', 'user_obj',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.user_obj'
        db.delete_column('Product', 'user_obj_id')

        # Deleting field 'Category.font_px'
        db.delete_column('Category', 'font_px')

        # Deleting field 'Category.user_obj'
        db.delete_column('Category', 'user_obj_id')
    ...
    models = {
        ...
        u'product.viewed': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_viewed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 6, 0, 0)'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1', 'db_index': 'True'}),
