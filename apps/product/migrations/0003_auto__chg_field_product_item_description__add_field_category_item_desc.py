...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.item_description'
        db.alter_column('Product', 'item_description', self.gf('django.db.models.fields.CharField')(max_length=128))
        # Adding field 'Category.item_description'
        db.add_column('Category', 'item_description',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Product.item_description'
        db.alter_column('Product', 'item_description', self.gf('django.db.models.fields.CharField')(max_length=64))
        # Deleting field 'Category.item_description'
        db.delete_column('Category', 'item_description')
    ...
    models = {
        ...
        u'product.viewed': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_viewed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 3, 0, 0)'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1', 'db_index': 'True'}),
