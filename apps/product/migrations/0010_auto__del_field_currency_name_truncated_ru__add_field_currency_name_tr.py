...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Currency.name_truncated_ru'
        db.delete_column('Currency', 'name_truncated_ru')

        # Adding field 'Currency.name_truncated'
        db.add_column('Currency', 'name_truncated',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Currency.currency'
        db.add_column('Currency', 'currency',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=12, decimal_places=5),
                      keep_default=False)

        # Adding field 'Currency.exchange_rate'
        db.add_column('Currency', 'exchange_rate',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=12, decimal_places=5),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Currency.name_truncated_ru'
        db.add_column('Currency', 'name_truncated_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Currency.name_truncated'
        db.delete_column('Currency', 'name_truncated')

        # Deleting field 'Currency.currency'
        db.delete_column('Currency', 'currency')

        # Deleting field 'Currency.exchange_rate'
        db.delete_column('Currency', 'exchange_rate')
    ...
    models = {
        ...
        u'product.viewed': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_viewed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 10, 0, 0)'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1', 'db_index': 'True'}),
