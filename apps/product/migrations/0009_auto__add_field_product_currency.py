...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('Product', 'currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['product.Currency']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.currency'
        db.delete_column('Product', 'currency_id')
    ...
    models = {
        ...
        u'product.viewed': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_viewed': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 5, 0, 0)'}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1', 'db_index': 'True'}),
