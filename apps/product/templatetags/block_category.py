...
def block_categories(categories, request, ):
    return render_to_string(template_name=u'category/templatetags/block_categories.jinja2',
...
def block_category(category, cycle, ):
    ...
    return render_to_string(template_name=u'category/templatetags/block_category.jinja2',
...
def this_category(category, width_this_category, ):
    ...
    return render_to_string(template_name=u'category/templatetags/this_category.jinja2',
                            context={'category': category,
