...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'UserModel', 'date_of_birth',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'User.username'
        db.alter_column(u'UserModel', 'username', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32))

    def backwards(self, orm):
        # Deleting field 'User.date_of_birth'
        db.delete_column(u'UserModel', 'date_of_birth')


        # Changing field 'User.username'
        db.alter_column(u'UserModel', 'username', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True))
