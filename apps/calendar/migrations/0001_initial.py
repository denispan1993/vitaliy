...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('product', '0003_auto_20151201_1519'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('date_start', models.DateField(default=datetime.date(2015, 12, 1), verbose_name='\u0414\u0430\u0442\u0430 \u043d\u0430\u0447\u0430\u043b\u0430 \u043c\u0435\u0440\u043e\u043f\u0440\u0438\u044f\u0442\u0438\u044f')),
                ('date_end', models.DateField(default=datetime.date(2015, 12, 1), verbose_name='\u0414\u0430\u0442\u0430 \u043e\u043a\u043e\u043d\u0447\u0430\u043d\u0438\u044f \u043c\u0435\u0440\u043e\u043f\u0440\u0438\u044f\u0442\u0438\u044f')),
                ('time_start', models.TimeField(default=datetime.time(15, 19, 34, 563845), verbose_name='\u0412\u0440\u0435\u043c\u044f \u043d\u0430\u0447\u0430\u043b\u0430 \u043c\u0435\u0440\u043e\u043f\u0440\u0438\u044f\u0442\u0438\u044f')),
                ('time_end', models.TimeField(default=datetime.time(15, 19, 34, 563918), verbose_name='\u0412\u0440\u0435\u043c\u044f \u043e\u043a\u043e\u043d\u0447\u0430\u043d\u0438\u044f \u043c\u0435\u0440\u043e\u043f\u0440\u0438\u044f\u0442\u0438\u044f')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.AddField(
            model_name='event',
            name='leading_course',
            field=models.ForeignKey(default=1, verbose_name='\u0412\u0435\u0434\u0443\u0449\u0438\u0439(\u0430\u044f) \u043a\u0443\u0440\u0441\u044b', to='calendar.LeadingCourse'),
        ),
        migrations.AddField(
            model_name='event',
            name='user',
