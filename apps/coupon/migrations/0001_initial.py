...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('CouponGroup', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(default='2014-12-21T01:16:04.289653', max_length=128, null=True, blank=True)),
            ('how_much_coupons', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=10)),
            ...
            ('end_of_the_coupon', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 3, 21, 0, 0))),
        ...
        db.create_table('Coupon', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='2014-12-21T01:16:04.292261', max_length=128, null=True, blank=True)),
    ...
    models = {
        ...
        u'coupon.coupon': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'end_of_the_coupon': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 21, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'2014-12-21T01:16:04.292261'", 'max_length': '128', 'null': 'True', 'blank': 'True'}),
        ...
        u'coupon.coupongroup': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'2014-12-21T01:16:04.289653'", 'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'number_of_possible_uses': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'percentage_discount': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '10'}),
            'start_of_the_coupon': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
