...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Coupon', fields ['key']
        db.create_unique('Coupon', ['key'])


    def backwards(self, orm):
        # Removing unique constraint on 'Coupon', fields ['key']
        db.delete_unique('Coupon', ['key'])
    ...
    models = {
        ...
        u'coupon.coupon': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 23, 0, 0)'}),
            'end_of_the_coupon': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 23, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'59ojlt'", 'unique': 'True', 'max_length': '8'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'2015-06-23T13:51:07.602946'", 'max_length': '128', 'null': 'True', 'blank': 'True'}),
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 23, 0, 0)'})
        },
        u'coupon.coupongroup': {
            'Meta': {'ordering': "['-created_at']", 'object_name': 'CouponGroup', 'db_table': "'CouponGroup'"},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 23, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'end_of_the_coupon': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 9, 23, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'how_much_coupons': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '10', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'2015-06-23T13:51:07.601576'", 'max_length': '128', 'null': 'True', 'blank': 'True'}),
            ...
            'start_of_the_coupon': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 23, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 23, 0, 0)', 'null': 'True', 'blank': 'True'})
        },
        u'product.country': {
