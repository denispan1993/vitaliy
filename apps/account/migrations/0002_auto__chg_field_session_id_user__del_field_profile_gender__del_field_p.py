...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Session_ID.user'
        db.alter_column(u'Session_ID', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['authModel.User']))
        # Deleting field 'Profile.gender'
        db.delete_column(u'Profile', 'gender')

        # Deleting field 'Profile.area'
        db.delete_column(u'Profile', 'area')

        # Deleting field 'Profile.country'
        db.delete_column(u'Profile', 'country')

        # Deleting field 'Profile.birthday'
        db.delete_column(u'Profile', 'birthday')

        # Deleting field 'Profile.phone'
        db.delete_column(u'Profile', 'phone')

        # Deleting field 'Profile.carrier'
        db.delete_column(u'Profile', 'carrier')

        # Deleting field 'Profile.patronymic'
        db.delete_column(u'Profile', 'patronymic')

        # Deleting field 'Profile.settlement'
        db.delete_column(u'Profile', 'settlement')


        # Changing field 'Profile.user'
        db.alter_column(u'Profile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['authModel.User']))

    def backwards(self, orm):

        # Changing field 'Session_ID.user'
        db.alter_column(u'Session_ID', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))
        # Adding field 'Profile.gender'
        db.add_column(u'Profile', 'gender',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.area'
        db.add_column(u'Profile', 'area',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.country'
        db.add_column(u'Profile', 'country',
                      self.gf('django.db.models.fields.CharField')(default=u'\u0423\u043a\u0440\u0430\u0438\u043d\u0430', max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.birthday'
        db.add_column(u'Profile', 'birthday',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.phone'
        db.add_column(u'Profile', 'phone',
                      self.gf('django.db.models.fields.CharField')(max_length=19, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.carrier'
        db.add_column(u'Profile', 'carrier',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.patronymic'
        db.add_column(u'Profile', 'patronymic',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.settlement'
        db.add_column(u'Profile', 'settlement',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Profile.user'
        db.alter_column(u'Profile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))
    ...
    models = {
        ...
        u'account.session_id': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 10, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sessionid': ('django.db.models.fields.CharField', [], {'max_length': '32', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 10, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
