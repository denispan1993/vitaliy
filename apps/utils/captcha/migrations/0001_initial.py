...
import apps.utils.captcha.models
import datetime
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to=apps.utils.captcha.models.set_path_photo, verbose_name='\u041a\u0430\u0440\u0442\u0438\u043d\u043a\u0430')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('key', models.CharField(default=apps.utils.captcha.views.key_generator, unique=True, max_length=8, verbose_name='\u041a\u0430\u043f\u0447\u0430 \u043a\u043e\u0434')),
