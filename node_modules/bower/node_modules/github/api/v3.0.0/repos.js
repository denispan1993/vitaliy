...
(function() {
     ...
     *  - ref (String): Optional. The String name of the Commit/Branch/Tag. Defaults to master.
     **/
    this.createContent = function(msg, block, callback) {
        var self = this;
        this.client.httpSend(msg, block, function(err, res) {
            if (err)
                return self.sendError(err, null, msg, callback);
     ...
     *  - task (String): Optional. The name of the task for the deployment. e.g. deploy or deploy:migrations.south. Default: none.
     ...
     *  - task (String): Required. The named task to execute. e.g. deploy or deploy:migrations.south. Default: deploy
