...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'CallBack', (
            ...
            ('phone', self.gf('django.db.models.fields.CharField')(default='phone number', max_length=32)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
        ))
        db.send_create_signal(u'callback', ['CallBack'])


    def backwards(self, orm):
        # Deleting model 'CallBack'
        db.delete_table(u'CallBack')
    ...
    models = {
        ...
        u'callback.callback': {
            'Meta': {'ordering': "[u'-created_at']", 'object_name': 'CallBack', 'db_table': "u'CallBack'"},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'phone': ('django.db.models.fields.CharField', [], {'default': "'phone number'", 'max_length': '32'}),
