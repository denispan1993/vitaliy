...
from applications.product.views import add_to_cart
...
def order_change(request, ):
    from applications.cart.models import Order, Product
    from applications.product.models import Product as real_Product
