...
class Command(BaseCommand, ):
    def handle(self, *args, **options):
        ...
        from applications.delivery.models import TraceOfVisits
        ...
        for visit in visits:
            ...
            try:
                ...
                print i, ' ', email
                print 'Description: ', 'From applications.delivery.model.SpamEmail'
                email = Email(email=email, description='From applications.delivery.model.SpamEmail', )
                email.save()
            else:
                print i, ' ', email
            i += 1
