...
from applications.product import models as models_product
from applications.product.models import Country, Product as real_Product
from applications.product.views import get_product
